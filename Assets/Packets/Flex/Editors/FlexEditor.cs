...
public class FlexEditor
{
    ...
    /// 自己定义的LeavesAssset
    /// </summary>
    [MenuItem(MENU_ROOT + "Create Asset/Leaves Asset", false, 150)]
    [MenuItem("Assets/Create/NVIDIA/Flex/Leaves Asset", false, 150)]
    static void CreateLeavesAssetAsset()
    {
        CreateAsset<LeavesAsset>("New LeavesAsset");
    }
